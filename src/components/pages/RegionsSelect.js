...
class RegionsSelect extends Component {
    constructor (props) {
        ...
        this.state={};
        this.state.regions = this.existingIgnoreBlokcs;
    ...
    render() {
        ...
        return (
            <div style={{ display: 'block' }}>
                ...
                <p>Ignored Regions <button onMouseUp={(event)=>{this.onSaveToBaseline(this.baselineDetails,event)}}>Save to Baseline</button>
